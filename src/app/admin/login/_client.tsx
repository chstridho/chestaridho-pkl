...
export default function AdminLoginClient() {
    ...
    // Sinkronisasi cookie session Supabase (opsional, bisa dihapus jika tidak perlu)
    useEffect(() => {
    ...
    return (
        <div ref={stageRef} className="theme-surface min-h-dvh grid place-items-center relative overflow-hidden">
            ...
            <div className="relative w-full">
                ...
                <div className="container-app py-12 relative">
                    ...
                    >
                        <h1 className={`${anton.className} text-4xl font-extrabold text-white`}>Sign In</h1>
                        <p className={`${manrope.className} mt-2 text-white/85`}>Masuk untuk mengelola portofolio anda.</p>
                    </motion.div>
                    ...
                    >
                        <div className="grid gap-4">
                            ...
                            <motion.div whileHover={{ scale: 1.01 }} transition={{ duration: 0.2 }}>
                                <label className="block text-xs font-semibold uppercase text-white/80">Email</label>
                            ...
                            {/* Password */}
                            <motion.div whileHover={{ scale: 1.01 }} transition={{ duration: 0.2 }}>
                                <label className="block text-xs font-semibold uppercase text-white/80">Password</label>
                            ...
                            <div className="flex items-center justify-between">
                                ...
                                <a href="/" className="text-xs text-white/80 hover:text-white transition">
                                    Kembali ke Home
                                </a>
                            </div>
